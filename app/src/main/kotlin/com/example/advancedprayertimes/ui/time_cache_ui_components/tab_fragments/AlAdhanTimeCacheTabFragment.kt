...
import kotlinx.android.synthetic.main.fragment_aladhan_time_cache.*

class AlAdhanTimeCacheTabFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_aladhan_time_cache, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for(entry in DBAlAdhanHelper.getAllAlAdhanPrayerTimes().sortedBy { x -> x.date }) {
            ...
            with(entry) {
                displayData.add(
                    arrayOf(
                        ...
                        maghribTime?.toStringByFormat("HH:mm") ?: "x",
                        //ishtibaqAnNujumTime?.toStringByFormat("HH:mm") ?: "-",
        ...
        if(displayData.any()) {
            aladhanTimeCache.addView(createTableLayout(this.requireContext(), displayData.toTypedArray()))
        }
    }
}