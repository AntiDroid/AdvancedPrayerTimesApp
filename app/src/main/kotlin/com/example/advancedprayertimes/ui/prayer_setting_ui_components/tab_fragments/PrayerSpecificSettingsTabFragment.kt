...
import com.example.advancedprayertimes.ui.prayer_setting_ui_components.PrayerSpecialSettingsPreferencesFragment

class PrayerSpecificSettingsTabFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val prayerSubtimeSettingsFragment = PrayerSpecialSettingsPreferencesFragment(
            _prayerType!!
        )
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(prayerType: EPrayerTimeType): PrayerSpecificSettingsTabFragment {

            val fragment = PrayerSpecificSettingsTabFragment()
            val args = Bundle()
