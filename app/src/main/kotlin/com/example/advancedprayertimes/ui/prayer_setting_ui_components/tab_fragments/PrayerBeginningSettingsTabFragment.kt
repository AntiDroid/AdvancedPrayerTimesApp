...
class PrayerBeginningSettingsTabFragment : Fragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(prayerType: EPrayerTimeType): PrayerBeginningSettingsTabFragment {

            val fragment = PrayerBeginningSettingsTabFragment()
            val args = Bundle()
