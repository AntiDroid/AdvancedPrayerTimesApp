...
import kotlinx.android.synthetic.main.fragment_diyanet_time_cache.*

class DiyanetTimeCacheTabFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_diyanet_time_cache, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for(entry in DBDiyanetHelper.getAllDiyanetPrayerTimes().sortedBy { x -> x.date }) {
        ...
        if(displayData.any()) {
            diyanetTimeCache.addView(createTableLayout(this.requireContext(), displayData.toTypedArray()))
        }
    }
}